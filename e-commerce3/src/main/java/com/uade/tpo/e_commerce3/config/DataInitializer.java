    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(3)
                    .marca("Apple")
                    .imagenUrl("/product-images/macbook-pro.png")
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(5)
                    .marca("Apple")
                    .imagenUrl("/product-images/iphone-pro.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(juan)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(2)
                    .marca("Bang & Olufsen")
                    .imagenUrl("/product-images/beosound-theatre.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(maria)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(1)
                    .marca("Hermès")
                    .imagenUrl("/product-images/birkin-bag.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(maria)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .imagenUrl("/product-images/traje-zegna.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(carlos)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(1)
                    .marca("Rolex")
                    .imagenUrl("/product-images/rolex-submariner.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(carlos)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(4)
                    .marca("Knoll")
                    .imagenUrl("/product-images/sillon-barcelona.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(juan)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(3)
                    .marca("Flos")
                    .imagenUrl("/product-images/lampara-arco.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(maria)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(2)
                    .marca("Pinarello")
                    .imagenUrl("/product-images/pinarello-dogma.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(carlos)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .stock(3)
                    .marca("Titleist")
                    .imagenUrl("/product-images/set-golf.png")
                    .estadoProducto(EstadoProducto.NUEVO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(juan)
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .imagenUrl("/product-images/martin-fierro.png")
            ...
            productoRepository.save(Producto.builder()
                    ...
                    .imagenUrl("/product-images/rayuela.png")
                    .estadoProducto(EstadoProducto.USADO)
                    .condicionPublicacion(CondicionPublicacion.ACTIVA)
                    .fechaPublicacion(LocalDate.now())
                    .vendedor(carlos)
